...
BROWSERS = (
    (re.compile('Edge'), _('Microsoft Edge')),
    (re.compile('Edg'), _('Microsoft Edge')),
    (re.compile('EdgiOS'), _('Microsoft Edge')),
    (re.compile('EdgA'), _('Microsoft Edge')),
    ...
    (re.compile('coc_coc_browser'), _('Coc Coc')),
